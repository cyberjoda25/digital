...
public class ConectorRsProviderMapper implements ResponseExceptionMapper<RuntimeException> {

    private ObjectMapper mapper;

    public ConectorRsProviderMapper() {
    ...
    public RuntimeException toThrowable(Response response) {
        ...
        switch (status) {
            ...
            default:
                return new MicroservicioExcepcion("", "Conector Rest", reason, reason);
        }
    }
    ...
    private IDinError obtenerDinError(String msgJson) {
        ...
        try {
            ...
            return mapper.readValue(msgJson, new TypeReference<ResponseRs<Object>>() {
            }).getDinError();
