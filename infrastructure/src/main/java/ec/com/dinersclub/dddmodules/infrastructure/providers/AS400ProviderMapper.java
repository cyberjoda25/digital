...
public class AS400ProviderMapper implements ResponseExceptionMapper<RuntimeException> {

    private ObjectMapper mapper;

    public AS400ProviderMapper() {
    ...
    public RuntimeException toThrowable(Response response) {
        ...
        switch (status) {
            ...
            default:
                return new MicroservicioExcepcion(null, "Conector AS400", reason, reason);
        }
    }
    ...
    private IDinError obtenerDinError(String msgJson) {
        ...
        try {
            ...
            throw new MicroservicioExcepcion(e, "Obtener DinError AS400");
        }
